...
if($('.mobile-menu').length){
    ...
    var mobileMenuContentMenuRes = $('.main-header .nav-outer .main-menu .collapse').html();
    $('.mobile-menu .menu-box .menu-outer').append(mobileMenuContentMenuRes);
